...
export default function About() {
  return (
    ...
    <div className="container mt-5">
      <div className="row">
        <div className="col-md-6">
          <h2 style={{ fontWeight: 'bold', marginTop: '150px', fontSize: '80px'}}>About</h2> 
        </div>
        <div className="col-md-6">
          <img
            src={AboutImage}
